...
function App() {
  ...
  function calcularsapatos() {
    let sapatos = Number(
      prompt("qual o valor do sapatos que você vai trocar:"),
    );
  ...
  function CalcularDivida() {
    ...
    if (custoM < dízimo) {
      ...
      alert(
        "ainda resta o total de R$" +
          divida_atualizada.toFixed(2) +
          " a ser pago",
      );
    }
  }
  ...
  function calcularBete() {
    ...
    let premiaçoes = Number(
      prompt("qual sera o valor gasto em premiações hoje:"),
    );
    let presentes = Number(
      prompt("qual sera o valor gasto em presentes hoje:"),
    );
    let comissoes = Number(
      prompt("qual sera o valor gasto em comissões hoje:"),
    );
  ...
  function calcularGanso() {
    let suprimentos = Number(
      prompt("quanto foi gasto em suprimentos e mercadoria"),
    );
    let ingressos = Number(
      prompt("quanto foi o faturamento da venda ingressos"),
    );
    ...
    alert(
      "lucro o em reais foi de R$" +
        lucroR.toFixed(2) +
        "\n e o lucro percentual foi de R$" +
        lucroP +
        "%",
    );
  }
  function calcularbomba() {
    ...
    if (valorbomba <= dinheiro) {
      alert(
        "o total de bombas gastas sera " +
          bombas +
          " e o total gasto sera R$" +
          valorbomba.toFixed(2),
      );
    } else {
      alert(
        "o total de bombas gastas sera " +
          bombas +
          " mas você não possui dinheiro o suficiente para comprar todas",
      );
    }
  }
  ...
  function calcularchurras() {
    ...
    if (nivel == "leve") {
      ...
      alert(
        "o quantia final de tudo sera de\n" +
          carne +
          "KG de carne\n" +
          cerveja +
          "L de cerveja\n" +
  ...
  function relatorio() {
    ...
    alert(
      "=== RELATÓRIO KOWALSKI ===\n" +
        ...
        valorPF.toFixed(2) +
        "\n" +
        "Média por relatório: R$ " +
        mediaValorPF.toFixed(2) +
        "\n" +
        "Tempo médio: " +
        mediaTempoPF.toFixed(0) +
        " minutos\n\n" +
        "DADOS PJ:\n" +
        "Relatórios: " +
        relatoriosPJ +
